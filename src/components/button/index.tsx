...
const Button = forwardRef<HTMLButtonElement, BtnProps>(({ onClick, id, title, leftIcon, rightIcon, containerClass, color = "text-[#fff]", radius = "rounded-2xl", padding = "px-7 py-5", size, family }, ref) => {
  return (
