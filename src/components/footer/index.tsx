...
const Footer = () => {
  ...
  return (
    <footer className="w-screen flex flex-col items-center justify-between pt-50 px-40 bg-[#161C2D]">
      <section className="w-4/5 h-auto flex items-start justify-between gap-[40px]">
        {sitemap.map(item =>
          <div className="flex flex-col items-start gap-10">
            <p className="text-[0.937em] text-left text-white/65 font-inter-regular">{item.heading}</p>
      ...
      <section className="w-4/5 h-30 mt-24 py-6 border-t-1 border-[#292F41] flex items-center justify-between">
